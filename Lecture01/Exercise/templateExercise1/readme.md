...
## **Objective**
The goal of this exercise is to build a simple **Memory Game** using JavaScript while only applying **previously learned concepts**. Solve the task using direct DOM manipulation and without loops or event listeners.
